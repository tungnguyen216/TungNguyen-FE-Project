...
/***/ (function(module, exports, __webpack_require__) {
	...
	var EkMain = exports.EkMain = function () {
	  function EkMain() {
	    _classCallCheck(this, EkMain);
	...
	var Home = function () {
	  ...
	  _createClass(Home, [{
	    ...
	    value: function init() {
	      ...
	      var skillChart = function skillChart() {
	        var storedUsers = JSON.parse(localStorage["users"]);
	        var allSkills = [];
	        var skillCounter = [];
	        var total = 0;

	        _jquery2.default.each(storedUsers, function (index, user) {
	          if (user.skills) {
	            var skills = user.skills.split(',');

	            _jquery2.default.each(skills, function (index, skill) {
	              allSkills.push(skill);
	            });
	          }
	        });

	        _jquery2.default.each(allSkills, function (index, skill) {
	          if (!skillCounter.length) {
	            var newSkill = _defineProperty({}, skill, 1);
	            skillCounter.push(newSkill);
	          } else {
	            var isExist = false;
	            _jquery2.default.each(skillCounter, function (index, skillC) {
	              if (skill === Object.keys(skillC).toString()) {
	                isExist = true;
	                var value = parseInt(Object.values(skillC)) + 1;
	                skillCounter[index] = _defineProperty({}, skill, value);
	                return;
	              }
	            });
	        ...
	        var skillChartData = [];
	        _jquery2.default.each(skillCounter, function (index, obj) {
	          var skillChart = {
	      ...
	      var skillHandler = function skillHandler() {
	        var $skillElms = (0, _jquery2.default)('.skill-elm__name');
	        var $skillInput = (0, _jquery2.default)('[name=user_skills]');
	        var skills = [];

	        _jquery2.default.each($skillElms, function (index, skillElm) {
	          var $skillElm = (0, _jquery2.default)(skillElm);
	      ...
	      var skillListCollapse = function skillListCollapse() {
	        var $skillResults = (0, _jquery2.default)('.skill-results');
	        var $skillList = (0, _jquery2.default)('.skill-list');
	      ...
	      var skillChooser = function skillChooser() {
	        var $skillElm = (0, _jquery2.default)('.skill-elm');
	        var $resultBoard = (0, _jquery2.default)('.skill-results__board');
	        ...
	        (0, _jquery2.default)('body').off('click').on('click', '.skill-elm__remove-btn', function (e) {
	          e.stopPropagation();
	          var $this = (0, _jquery2.default)(this);
	      ...
	      var formValidation = function formValidation() {
	        var $inputs = (0, _jquery2.default)('#user_form input');
	        var isValid = true;

	        _jquery2.default.each($inputs, function (index, input) {
	      ...
	      var userFormSubmit = function userFormSubmit() {
	        ...
	        (0, _jquery2.default)('.user-form__submit button').off('click').on('click', function () {
	          if (!formValidation()) {
	            return;
	          }
	          ...
	          var $userName = (0, _jquery2.default)('[name=user_name]');
	          var $userEmail = (0, _jquery2.default)('[name=user_email]');
	          var $userWebsite = (0, _jquery2.default)('[name=user_website]');
	          var $userSkills = (0, _jquery2.default)('[name=user_skills]');
	          var $userGender = (0, _jquery2.default)('[name=user_gender]:checked');
	      ...
	      var loadUserList = function loadUserList() {
	        if (localStorage["users"]) {
	          ...
	          var userListHtml = [];
	          var $userTable = (0, _jquery2.default)('.user-list__content__table tbody');

	          _jquery2.default.each(users, function (index, user) {
	            var userHtml = '<tr>' + '<td class="__name">' + user.name + '</td>' + '<td class="__email">' + user.email + '</td>' + '<td class="__skills">' + user.skills + '</td>' + '<td class="__gender">' + user.gender + '</td>' + '<td class="__action">' + '<button class="__action__edit" data-toggle="modal" data-target="#user_modal"><i class="glyphicon glyphicon-edit"> </i><span>Edit</span></button>' + '<button class="__action__delete"><i class="glyphicon glyphicon-trash"></i><span>Delete</span></button>' + '</td>' + '</tr>';
	      ...
	      var deleteUser = function deleteUser() {
	        (0, _jquery2.default)('.user-list__content__table .__action__delete').off('click').on('click', function () {
	          var $this = (0, _jquery2.default)(this);
	          var $userRow = $this.parents('tr');
	          var currentEmail = $userRow.find('.__email').text();
	          var storedUsers = JSON.parse(localStorage["users"]);
	      ...
	      var editUser = function editUser() {
	        (0, _jquery2.default)('.user-list__content__table .__action__edit').off('click').on('click', function () {
	          var $this = (0, _jquery2.default)(this);
	          var $userRow = $this.parents('tr');
	          var $currentName = $userRow.find('.__name');
	          var $currentEmail = $userRow.find('.__email');

	          var $formUserName = (0, _jquery2.default)('[name=user_name]');
	          var $formEmail = (0, _jquery2.default)('[name=user_email]');
	      ...
	      (0, _jquery2.default)('#user_form input').on('change keyup blur', function () {
	        var $this = (0, _jquery2.default)(this);
	        validation($this);
	        progressBar();
	      });
	      ...
	      var progressBar = function progressBar() {
	        var $inputs = (0, _jquery2.default)('#user_form input[type=text],#user_form input[type=email]');
	        var $validInput = $inputs.parents('.user-form__group.valid');

	        var $progressStick = (0, _jquery2.default)('.user-form__progress-bar__stick');
	        var $progressBar = $progressStick.parent();
	        var percentage = $progressBar.width() / 100 * ($validInput.length / $inputs.length * 100);
